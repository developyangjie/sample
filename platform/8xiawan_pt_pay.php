...
// 	$sign="ee5c9cfdec12277c7fed82b1959730df";
	...
	if(!isset($order))
	{	
		$cuid=intval(_sql_fetch_one_cell("select uid from cuser where loginname='$puid'"));
		...
		{	
			...
			{							
				...
				// 记录订单号
				$params="oid="."$oid"."_"."uid="."$puid"."_"."money="."$money"."_"."sid="."$serverid"."_"."itemid="."$itemid"."_"."pid="."$pid"."_"."sign="."$sign";
